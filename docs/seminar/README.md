...
| [`slides/세션1_스레드모델과_주소매핑.pptx`](slides/) | 세션 1 슬라이드 덱 (15매, 다이어그램 포함 — 스레드 레이아웃·인덱싱 + 실행 모델 SW→HW 매핑 + SM 내부 구조) | ✅ 완성 |
...
| [`slides/세션3_공유메모리와_병렬리덕션.pptx`](slides/) | 세션 3 슬라이드 덱 (12매, 다이어그램 포함 — CUDA 메모리 계층 조망 추가) | ✅ 완성 |
